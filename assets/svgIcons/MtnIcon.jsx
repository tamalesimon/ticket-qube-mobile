...
const MTN = (props) => (
  <Svg
    ...
    {...props}
  >
    <Path fill="#ffc403" d="M0 0h820v820H0z" />
    <Path d="M364.5 361.6v93.6h-25.6v-52.5L321.8 428h-13.4l-18.8-25.3v52.5h-23.4v-93.6h23.6l27 36.7 24.2-36.7zm7.4 21.2v-21.2h87.4v21.2h-30.6v72.4h-26.1v-72.4zm183.7-21.2v93.6h-21.5l-44-53.5v53.5h-23.4v-93.6H490l42.1 51.6v-51.6z" />
